...
namespace DataAccess.NHibernate
{
    public class SessionProvider
    {
        ...
        public SessionProvider()
        {
            ...
            modelMapper.AddMapping<InvitationMap>();
            modelMapper.AddMapping<RoomMap>();
            modelMapper.AddMapping<SongMap>();
            modelMapper.AddMapping<UserMap>();
            modelMapper.AddMapping<EmailMessageMap>();
            modelMapper.AddMapping<PlaylistMap>();
            modelMapper.AddMapping<AddToFriendRequestMap>();
